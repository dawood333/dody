...
#define MT_GPUFREQ_BATT_OC_LIMIT_FREQ           (532000)        /* KHz */

/**************************************************
 * Battery Percentage Protect
 **************************************************/
#define MT_GPUFREQ_BATT_PERCENT_PROTECT         0
#define MT_GPUFREQ_BATT_PERCENT_LIMIT_FREQ      (532000)        /* KHz */

/**************************************************
 * Low Battery Volume Protect
 **************************************************/
#define MT_GPUFREQ_LOW_BATT_VOLT_PROTECT        1
#define MT_GPUFREQ_LOW_BATT_VOLT_LIMIT_FREQ     (532000)        /* KHz */
...
struct opp_table_info g_opp_table_segment_1[] = {
    GPUOP(950000, 80000, 80000, POSDIV_POWER_4, 1875), /* OC, not sign-off */
    GPUOP(942000, 80000, 80000, POSDIV_POWER_4, 1875), /* 1 */
    GPUOP(935000, 80000, 80000, POSDIV_POWER_4, 1875), /* 2 */
    GPUOP(928000, 80000, 80000, POSDIV_POWER_4, 1875), /* 3 */
    GPUOP(921000, 80000, 80000, POSDIV_POWER_4, 1875), /* 4 */
    GPUOP(914000, 80000, 80000, POSDIV_POWER_4, 1875), /* 5 */
    GPUOP(907000, 80000, 80000, POSDIV_POWER_4, 1875), /* 6 */
    GPUOP(900000, 80000, 80000, POSDIV_POWER_4, 1875), /* 7 */
    GPUOP(893000, 80000, 80000, POSDIV_POWER_4, 1875), /* 8 */
    GPUOP(886000, 80000, 80000, POSDIV_POWER_4, 1875), /* 9 sign off */
    GPUOP(879000, 79375, 79375, POSDIV_POWER_4, 1875), /* 10 */
    GPUOP(873000, 78750, 78750, POSDIV_POWER_4, 1875), /* 11 */
    GPUOP(867000, 78125, 78125, POSDIV_POWER_4, 1875), /* 12 */
    GPUOP(861000, 77500, 77500, POSDIV_POWER_4, 1875), /* 13 */
    GPUOP(854000, 76875, 76875, POSDIV_POWER_4, 1875), /* 14 */
    GPUOP(848000, 76250, 76250, POSDIV_POWER_4, 1875), /* 15 */
    GPUOP(842000, 75625, 75625, POSDIV_POWER_4, 1875), /* 16 */
    GPUOP(836000, 75000, 75000, POSDIV_POWER_4, 1875), /* 17 sign off */
    GPUOP(825000, 74375, 75000, POSDIV_POWER_4, 1875), /* 18 */
    GPUOP(815000, 73750, 75000, POSDIV_POWER_4, 1875), /* 19 */
    GPUOP(805000, 73125, 75000, POSDIV_POWER_4, 1875), /* 20 */
    GPUOP(795000, 72500, 75000, POSDIV_POWER_4, 1875), /* 21 */
    GPUOP(785000, 71875, 75000, POSDIV_POWER_4, 1875), /* 22 */
    GPUOP(775000, 71250, 75000, POSDIV_POWER_4, 1875), /* 23 */
    GPUOP(765000, 70625, 75000, POSDIV_POWER_4, 1875), /* 24 */
    GPUOP(755000, 70000, 75000, POSDIV_POWER_4, 1875), /* 25 */
    GPUOP(745000, 69375, 75000, POSDIV_POWER_4, 1875), /* 26 */
    GPUOP(735000, 68750, 75000, POSDIV_POWER_4, 1875), /* 27 */
    GPUOP(725000, 68125, 75000, POSDIV_POWER_4, 1875), /* 28 */
    GPUOP(715000, 67500, 75000, POSDIV_POWER_4, 1875), /* 29 */
    GPUOP(705000, 66875, 75000, POSDIV_POWER_4, 1250), /* 30 */
    GPUOP(695000, 66250, 75000, POSDIV_POWER_4, 1250), /* 31 */
    GPUOP(685000, 65625, 75000, POSDIV_POWER_4, 1250), /* 32 */
    GPUOP(675000, 65000, 75000, POSDIV_POWER_4, 1250), /* 33 sign off */
    GPUOP(654000, 64375, 75000, POSDIV_POWER_4, 1250), /* 34 */
    GPUOP(634000, 63750, 75000, POSDIV_POWER_4, 1250), /* 35 */
    GPUOP(614000, 63125, 75000, POSDIV_POWER_4, 1250), /* 36 */
    GPUOP(593000, 62500, 75000, POSDIV_POWER_4, 1250), /* 37 */
    GPUOP(573000, 61875, 75000, POSDIV_POWER_4, 1250), /* 38 */
    GPUOP(553000, 61250, 75000, POSDIV_POWER_4, 1250), /* 39 */
    GPUOP(532000, 60625, 75000, POSDIV_POWER_4, 1250), /* 40 */
};
